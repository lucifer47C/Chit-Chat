  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        "encryption-verified": "hsl(var(--encryption-verified))",
        "encryption-pending": "hsl(var(--encryption-pending))",
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      animation: {
        ...
        "lock-secure": "lock-secure 0.5s ease-out",
        shimmer: "shimmer 2s linear infinite",
      },
      boxShadow: {
        'glow': 'var(--shadow-glow)',
        'glow-lg': '0 0 30px hsl(var(--primary) / 0.25)',
      },
    },
  },
